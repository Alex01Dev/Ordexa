...
export const ProductFormScreen = ({ navigation, route }: Props) => {
    ...
    const handleSave = () => {
        if (!name.trim() || !sku.trim() || !price.trim()) {
            Alert.alert('Faltan datos', 'Nombre, SKU y precio son obligatorios');
            return;
        }
    ...
    return (
        <ScrollView style={styles.container}>
            ...
            <TextInput style={styles.input} value={name} onChangeText={setName} placeholder="Ej. Coca-Cola 600ml" />
            ...
            <View style={{ flexDirection: 'row', gap: 8, alignItems: 'center' }}>
                ...
                {!editing && (
                    <TouchableOpacity
                        ...
                        onPress={() => navigation.navigate('Scanner', {mode: 'IN'} )}
                    >
            ...
            <TextInput style={styles.input} value={stock} onChangeText={setStock} keyboardType="number-pad" editable={!editing} />
            ...
            <Text style={styles.label}>Stock mínimo (alerta)</Text>
            <Text style={styles.helperText}>
                Cuando el stock llegue a este número o menos, el producto aparecerá en "Stock bajo".
            </Text>
            <TextInput style={styles.input} value={minStock} onChangeText={setMinStock} keyboardType="number-pad" />
...
const styles = StyleSheet.create({
    ...
    helperText: { fontSize: 12, color: '#6B7280', marginTop: -2, marginBottom: 6 },
    scanIconBtn: { padding: 10, backgroundColor: '#F3F4F6', borderRadius: 8 },
    chipsWrap: { flexDirection: 'row', flexWrap: 'wrap', gap: 8 },
    chip: { paddingVertical: 8, paddingHorizontal: 12, borderRadius: 16, borderWidth: 1, borderColor: '#E5E7EB', backgroundColor: '#fff' },
